...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className="fixed z-50 flex flex-col items-center justify-center gap-1 transition-all duration-300 bg-black rounded-full cursor-pointer w-16 h-16 md:w-19 md:h-19 top-4 right-10"
        onClick={toggleMenu}
        style={
          showBurger
